...
function benchmarks_models(; n::Int=10, k::Int=10, number_of_samples::Int=100, verbose::Bool=true)
  ...
  MatCov = VecchiaMLE.GenerateMatCov(n, params, xyGrid)

  samples_cpu = VecchiaMLE.GenerateSamples(MatCov, n, number_of_samples; mode=cpu)
  samples_gpu = VecchiaMLE.GenerateSamples(MatCov, n, number_of_samples; mode=gpu)
