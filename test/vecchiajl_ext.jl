...
@testset begin "Vecchia.jl extension"
  ...
  pts = rand(StableRNG(12345), SVector{2,Float64}, 100)
  z   = randn(StableRNG(123), length(pts), 1000)
  ...
  (perm, nlp) = VecchiaModel(pts, sim, RandomOrdering(StableRNG(1234)), KNNConditioning(10);
